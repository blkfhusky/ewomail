...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return MESSAGES_PER_PAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return MESSAGES_PER_PAGE_VALUES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return CONTACTS_PER_PAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return DEFAULT_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return SEARCH_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return SEND_MESSAGE_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return SAVE_MESSAGE_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return CONTACTS_SYNC_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return UNUSED_OPTION_VALUE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return CLIENT_SIDE_STORAGE_INDEX_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return IMAP_DEFAULT_PORT; });
/* unused harmony export IMAP_DEFAULT_SECURE_PORT */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return SMTP_DEFAULT_PORT; });
/* unused harmony export SMTP_DEFAULT_SECURE_PORT */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return SIEVE_DEFAULT_PORT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return MESSAGE_BODY_CACHE_LIMIT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return AJAX_ERROR_LIMIT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return TOKEN_ERROR_LIMIT; });
/* unused harmony export RAINLOOP_TRIAL_KEY */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return DATA_IMAGE_USER_DOT_PIC; });
...
var AbstractAjaxRemote = function () {
	...
	AbstractAjaxRemote.prototype.defaultResponse = function defaultResponse(fCallback, sRequestAction, sType, oData, bCached, oRequestParameters) {
		var fCall = function fCall() {
			...
			if (__WEBPACK_IMPORTED_MODULE_5_Common_Enums__["StorageResultType"].Success === sType && oData && !oData.Result) {
				...
				if (__WEBPACK_IMPORTED_MODULE_4_Common_Consts__["d" /* TOKEN_ERROR_LIMIT */] < __WEBPACK_IMPORTED_MODULE_7_Common_Globals__["data"].iTokenErrorCount) {
				...
				if (oData.ClearAuth || oData.Logout || __WEBPACK_IMPORTED_MODULE_4_Common_Consts__["e" /* AJAX_ERROR_LIMIT */] < __WEBPACK_IMPORTED_MODULE_7_Common_Globals__["data"].iAjaxErrorCount) {
  ...
  */
	...
	AbstractAjaxRemote.prototype.defaultRequest = function defaultRequest(fCallback, sAction, oParameters, iTimeout, sGetAdd, aAbortActions) {
		...
		return this.ajaxRequest(fCallback, oParameters, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_Common_Utils__["isUnd"])(iTimeout) ? __WEBPACK_IMPORTED_MODULE_4_Common_Consts__["f" /* DEFAULT_AJAX_TIMEOUT */] : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_Common_Utils__["pInt"])(iTimeout), sGetAdd, aAbortActions);
	};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_Stores_Admin_License__ = __webpack_require__(/*! Stores/Admin/License */ 240);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_Screen_Admin_Settings__ = __webpack_require__(/*! Screen/Admin/Settings */ 215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_Screen_Admin_Login__ = __webpack_require__(/*! Screen/Admin/Login */ 214);
...
var DomainPopupView = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14_Knoin_Knoin__["popup"])({
	...
	function DomainPopupView() {
		...
		_this.imapPort = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["a" /* IMAP_DEFAULT_PORT */]);
		...
		_this.sievePort = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["b" /* SIEVE_DEFAULT_PORT */]);
		...
		_this.smtpPort = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["c" /* SMTP_DEFAULT_PORT */]);
	...
	DomainPopupView.prototype.clearForm = function clearForm() {
		...
		this.imapServer('');
		this.imapPort('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["a" /* IMAP_DEFAULT_PORT */]);
		...
		this.sieveServer('');
		this.sievePort('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["b" /* SIEVE_DEFAULT_PORT */]);
		this.sieveSecure(__WEBPACK_IMPORTED_MODULE_6_Common_Enums__["ServerSecure"].None);

		this.smtpServer('');
		this.smtpPort('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["c" /* SMTP_DEFAULT_PORT */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_View_Admin_Login__ = __webpack_require__(/*! View/Admin/Login */ 241);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Settings_Admin_General__ = __webpack_require__(/*! Settings/Admin/General */ 223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Settings_Admin_Login__ = __webpack_require__(/*! Settings/Admin/Login */ 224);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Settings_Admin_Contacts__ = __webpack_require__(/*! Settings/Admin/Contacts */ 221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Settings_Admin_Domains__ = __webpack_require__(/*! Settings/Admin/Domains */ 222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Settings_Admin_Security__ = __webpack_require__(/*! Settings/Admin/Security */ 227);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Settings_Admin_Social__ = __webpack_require__(/*! Settings/Admin/Social */ 228);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_Settings_Admin_Plugins__ = __webpack_require__(/*! Settings/Admin/Plugins */ 226);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_Settings_Admin_Packages__ = __webpack_require__(/*! Settings/Admin/Packages */ 225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_Settings_Admin_About__ = __webpack_require__(/*! Settings/Admin/About */ 219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_View_Admin_Settings_Menu__ = __webpack_require__(/*! View/Admin/Settings/Menu */ 242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_View_Admin_Settings_Pane__ = __webpack_require__(/*! View/Admin/Settings/Pane */ 243);
...
var SettingsAdminScreen = function (_AbstractSettingsScre) {
  ...
  */
	...
	SettingsAdminScreen.prototype.setupSettings = function setupSettings() {
		...
		if (true) {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Knoin_Knoin__["addSettingsViewModel"])(__webpack_require__(/*! Settings/Admin/Branding */ 220).default, 'AdminSettingsBranding', 'TABS_LABELS/LABEL_BRANDING_NAME', 'branding');
		} else {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BrandingAdminSettings", function() { return BrandingAdminSettings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return BrandingAdminSettings; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck__ = __webpack_require__(/*! babel-runtime/helpers/classCallCheck */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1____ = __webpack_require__(/*! _ */ 6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1____);
...
var DomainsAdminSettings = function () {
	...
	DomainsAdminSettings.prototype.createDomainAlias = function createDomainAlias() {
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/DomainAlias */ 247));
	};
...
var PluginsAdminSettings = function () {
	...
	PluginsAdminSettings.prototype.onPluginLoadRequest = function onPluginLoadRequest(result, data) {
		if (__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["StorageResultType"].Success === result && data && data.Result) {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/Plugin */ 251), [data.Result]);
		}
	};
